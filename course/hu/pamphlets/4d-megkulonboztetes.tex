...
\begin{itemize}
    ...
    \item \textbf{Teljesítmény megkülönböztetés:} Annak értékelése, hogyan viselkedik az MI az interakció során, figyelembe véve, hogy kommunikációs stílusa hatékony-e az igényeidnek.
\end{itemize}
